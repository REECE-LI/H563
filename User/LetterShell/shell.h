...
#define SHELL_EXPORT_CMD(cmd, func, desc)                                                                              \
  ...
  const SHELL_CommandTypeDef shellCommand##cmd SECTION("shellCommand") = {shellCmd##cmd, (int (*)())func,              \
                                                                          shellDesc##cmd, (void *)0}
#define SHELL_EXPORT_CMD_EX(cmd, func, desc, help)                                                                     \
  const char shellCmd##cmd[] = #cmd;                                                                                   \
  const char shellDesc##cmd[] = #desc;                                                                                 \
  const char shellHelp##cmd[] = #help;                                                                                 \
  __attribute__((used, section("shellCommand"))) const SHELL_CommandTypeDef shellCommand##cmd SECTION(                 \
      "shellCommand") = {shellCmd##cmd, (int (*)())func, shellDesc##cmd, shellHelp##cmd}
...
#define SHELL_EXPORT_VAR(var, variable, desc, type)                                                                    \
  ...
  const SHELL_VaribaleTypeDef shellVariable##var SECTION("shellVariable") = {shellVar##var, (void *)(variable),        \
                                                                             shellDesc##var, type}
#else
#define SHELL_EXPORT_VAR(var, variable, desc, type)
...
#define SHELL_EXPORT_VAR_INT(var, variable, desc) SHELL_EXPORT_VAR(var, &variable, desc, SHELL_VAR_INT)
#define SHELL_EXPORT_VAR_SHORT(var, variable, desc) SHELL_EXPORT_VAR(var, &variable, desc, SHELL_VAR_SHORT)
#define SHELL_EXPORT_VAR_CHAR(var, variable, desc) SHELL_EXPORT_VAR(var, &variable, desc, SHELL_VAR_CHAR)
#define SHELL_EXPORT_VAR_POINTER(var, variable, desc) SHELL_EXPORT_VAR(var, variable, desc, SHELL_VAR_POINTER)
#define SHELL_EXPORT_VAL(val, value, desc) SHELL_EXPORT_VAR(val, value, desc, SHELL_VAL)
...
#if SHELL_LONG_HELP == 1
#define SHELL_CMD_ITEM(cmd, func, desc) {#cmd, (int (*)())func, #desc, (void *)0}
#define SHELL_CMD_ITEM_EX(cmd, func, desc, help) {#cmd, (int (*)())func, #desc, #help}
#else /** SHELL_LONG_HELP == 1 */
#define SHELL_CMD_ITEM(cmd, func, desc) {#cmd, (int (*)())func, #desc}
...
#define SHELL_VAR_ITEM_INT(var, variable, desc) SHELL_VAR_ITEM(var, &variable, desc, SHELL_VAR_INT)
#define SHELL_VAR_ITEM_SHORT(var, variable, desc) SHELL_VAR_ITEM(var, &variable, desc, SHELL_VAR_SHORT)
#define SHELL_VAR_ITEM_CHAR(var, variable, desc) SHELL_VAR_ITEM(var, &variable, desc, SHELL_VAR_CHAR)
#define SHELL_VAR_ITEM_POINTER(var, variable, desc) SHELL_VAR_ITEM(var, variable, desc, SHELL_VAR_POINTER)
...
#define shellInput shellHandler
  ...
  extern uint8_t shellRxBuffer[SHELL_COMMAND_MAX_LENGTH];

  void ShellWrite(char data);

  typedef struct
  {
    uint8_t data[SHELL_COMMAND_MAX_LENGTH];
    uint16_t len;
  } ShellMsgPtr_t;
